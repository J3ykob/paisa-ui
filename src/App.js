  ...
  componentDidMount() {
    this.setState({
      data: {
        ...
        Account: parseInt(localStorage.getItem("Account") || ""),
      ...
      < Router >
        ...
        <Switch>
          <Route
            exact
            path="/login"
            render={props => {console.log(this.state.data["Account"])
             return this.state.data["Account"] === 1 ? (
                // <Dashboard />
                <Redirect to="/admin" />
          ...
          <Route
            ...
            render={_ => {
              ...
              return this.state.data["Account"] === 2 ? (
                <DashboardHR
                  data={this.state.data}
                  onLogout={this.handleLogout}
                />
