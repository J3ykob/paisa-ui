    ...
    csvFile.onchange = function (e) {
      ...
      reader.onload = function (e) {
        ...
        data.forEach((data) => {
          let body = {
            Email: data["Email"],
            Password: "start_" + data["First Name"],
            Account: 3,
            RoleID: data["Role"],
            Gender: null,
            ...
            DOB: null,
            ContactNo: data["Contact No"] || null,
            EmployeeCode: data["Employee Code"],
            DepartmentID: data["Branch Name"],
            PositionID: data["Position"],
            DateOfJoining: data["Date of Joining\r"],
            TerminateDate: null,
          };
          employees.push(body);
        });
        ...
        axios
          .post(
            process.env.REACT_APP_API_URL + "/api/employee/uploadCSV",
            employees,
            {
              headers: {
                authorization: localStorage.getItem("token") || "",
