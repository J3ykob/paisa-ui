...
class EmployeeFormEdit extends Component {
  state = {
    ...
    DOBData: this.props.editData["DOB"]
      ? this.props.editData["DOB"].slice(0, 10)
      : "",
    ...
    TerminateDateData: (this.props.editData["TerminateDate"] || "").slice(
      0,
      10
    ),
  ...
  deactivateEmployee() {
    axios
      .delete(process.env.REACT_APP_API_URL + "/api/employee/", {
        headers: {
          authorization: localStorage.getItem("token") || "",
        },
      })
  ...
  render() {
    return (
      <React.Fragment>
        ...
        <Button variant="danger" onClick={(e) => this.deactivateEmployee()}>
          Deactivate Employee
        </Button>{" "}
          ...
          >
            ...
            <Form.Group as={Row}>
              ...
              <Col sm={10} className="form-input">
                <Form.Control
                  type="date"
                  placeholder="Terminate Date (optional)"
